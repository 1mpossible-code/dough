      ...
      <Menu setActive={setActive}>
        ...
        <MenuItem setActive={setActive} active={active} item="Insights">
          <div className="flex flex-col space-y-4 text-sm">
            ...
            <HoveredLink href="/metrics">Metrics</HoveredLink>
            <HoveredLink href="/transactions">Transactions</HoveredLink>
            <HoveredLink href="/predictions">Predictions</HoveredLink>
            <HoveredLink href="/recommendations">Recommendations</HoveredLink>
          </div>
        </MenuItem>
